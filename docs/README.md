# Dokumentation – Intelligent Heating Control
...
|----------|-------------|
| [Installation](installation.md) | Detaillierte Installationsanleitung (HACS & manuell) |
...
1. [Installation via HACS](installation.md#via-hacs-empfohlen)
2. [Ersteinrichtung](configuration.md#setup-wizard-ersteinrichtung)
3. [Erstes Zimmer hinzufügen](configuration.md#zimmer-verwalten)
4. [Heizkurve anpassen](configuration.md#heizkurve-konfigurieren)
5. [Zeitpläne erstellen](configuration.md#zeitpläne-konfigurieren)

...
from .const import (
    ...
    CONF_FELT_TEMP_ADJUSTMENT_ENABLED, DEFAULT_FELT_TEMP_ADJUSTMENT_ENABLED,
    CONF_FELT_TEMP_ADJUSTMENT_MAX, DEFAULT_FELT_TEMP_ADJUSTMENT_MAX,
    ...
    CONF_SOLAR_MIN_ELEVATION, DEFAULT_SOLAR_MIN_ELEVATION,
    CONF_SOLAR_SHADE_POSITION, DEFAULT_SOLAR_SHADE_POSITION,
    CONF_SOLAR_HEAT_MIN_OUTDOOR, DEFAULT_SOLAR_HEAT_MIN_OUTDOOR,
...
class IHCTotalDemandSensor(_IHCBase, SensorEntity):
    ...
    def extra_state_attributes(self) -> dict:
        ...
        return {
            ...
            "summer_mode_auto_active": d.get("summer_mode_auto_active", False),
            "summer_mode_rolling_avg": d.get("summer_mode_rolling_avg"),
    ...
    def _get_global_config_attrs(self) -> dict:
        ...
        return {
            ...
            "summer_mode_hysteresis_enabled": cfg.get(CONF_SUMMER_MODE_HYSTERESIS_ENABLED, DEFAULT_SUMMER_MODE_HYSTERESIS_ENABLED),
            "summer_mode_hysteresis_band":    cfg.get(CONF_SUMMER_MODE_HYSTERESIS_BAND, DEFAULT_SUMMER_MODE_HYSTERESIS_BAND),
            "summer_mode_hysteresis_days":    cfg.get(CONF_SUMMER_MODE_HYSTERESIS_DAYS, DEFAULT_SUMMER_MODE_HYSTERESIS_DAYS),
            ...
            "felt_temp_adjustment_enabled": cfg.get(CONF_FELT_TEMP_ADJUSTMENT_ENABLED, DEFAULT_FELT_TEMP_ADJUSTMENT_ENABLED),
            "felt_temp_adjustment_max":     cfg.get(CONF_FELT_TEMP_ADJUSTMENT_MAX, DEFAULT_FELT_TEMP_ADJUSTMENT_MAX),
            ...
            "solar_min_elevation":         cfg.get(CONF_SOLAR_MIN_ELEVATION, DEFAULT_SOLAR_MIN_ELEVATION),
            "solar_shade_position":        cfg.get(CONF_SOLAR_SHADE_POSITION, DEFAULT_SOLAR_SHADE_POSITION),
            "solar_heat_min_outdoor":      cfg.get(CONF_SOLAR_HEAT_MIN_OUTDOOR, DEFAULT_SOLAR_HEAT_MIN_OUTDOOR),

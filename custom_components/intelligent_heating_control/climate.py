...
class IHCRoomClimate(CoordinatorEntity, ClimateEntity):
    ...
    def extra_state_attributes(self) -> dict:
        ...
        return {
            ...
            # Roadmap 2.1 – Passive Solar Heating/Shading via Rollosteuerung
            "cover_entities": room_cfg.get(CONF_COVER_ENTITIES, []),
            "window_orientation": room_cfg.get(CONF_WINDOW_ORIENTATION, ""),
            "solar_passive_heat": room_cfg.get(CONF_SOLAR_PASSIVE_HEAT, DEFAULT_SOLAR_PASSIVE_HEAT),
            "solar_passive_cool": room_cfg.get(CONF_SOLAR_PASSIVE_COOL, DEFAULT_SOLAR_PASSIVE_COOL),
            "solar_cover_active": d.get("solar_cover_active", False),
            "solar_cover_position": d.get("solar_cover_position"),
